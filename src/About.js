            ...
            <section id="about-me" className="underline">
                ...
                <div className="timeline">
                    ...
                    <ul>
                        ...
                        <li className="list-element"><strong>2023</strong> - I was still using my career in insruance as a backbone to keep food on the table, but I knew it was not my passion. It wasn't until December 18th, 2023 that I would take my full leap into web-development.</li>
