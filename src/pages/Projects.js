            ...
            <section id="projects" className="underline" style={{paddingBottom: '1rem'}}>
                ...
                <div id="project-grid" className="parent">
                    ...
                    <div className="div4 grid-item">
                        ...
                        <a href="https://main.d255j9osh5go8e.amplifyapp.com/" target="_blank">
                    ...
                    <div className="div7 grid-item">
                        ...
                        <a href="https://main--aether-quote-machine.netlify.app/" target="_blank">
                    ...
                    <div className="div2 grid-item">
                        ...
                        <a href="https://aether-pokemon-search.netlify.app/" target="_blank">
                    ...
                    <div className="div5 grid-item">
                        ...
                        <a href='https://aether-cash-register.netlify.app/' target="_blank">
                    ...
                    <div className="div8 grid-item">
                        ...
                        <a href="https://main--aether-phone-validator.netlify.app/" target="_blank">
                    ...
                    <div className="div14 grid-item">
                        ...
                        <a href="https://aether-roman-numeral-converter.netlify.app/" target="_blank">
                    ...
                    <div className="div11 grid-item">
                        ...
                        <a href="https://aether-palindrome-checker.netlify.app/" target="_blank">
                    ...
                    <div className="div12 grid-item">
                        ...
                        <a href="https://github.com/johnson7m/portfolio-website" target="_blank">
                    ...
                    <div className="div3 grid-item">
                        ...
                        <a href="https://aether-product-landing-page.netlify.app/" target="_blank">
                            <img className="project-image" src={project3}></img>
                        </a>
                    </div>
                    <div className="div6 grid-item">
                        <p className='project-header'>Docs Page (HTML5/CSS)</p>
                        <a href="https://main--aether-tech-docs.netlify.app/" target="_blank">
                    ...
                    <div className="div9 grid-item">
                        ...
                        <a href="https://main--aether-tribute-page.netlify.app/" target='_blank'>
                    ...
                    <div className="div15 grid-item">
                        ...
                        <a href="https://aether-survey.netlify.app/" target="_blank">
